...
export const riskData = [
  ...
  {
    label: "Algal Bloom Risk",
    level: "Moderate",
    confidence: "88%",
    trend: "Rising",
    color: "#f59e0b",
    desc: "Slight nutrient increase",
  },
  {
  ...
  },
  {
    ...
    trend: "Rising",
    color: "#f59e0b",
    desc: "DO decreasing at Buoy 02",
  },
  {
    label: "Acidification Risk",
    level: "Low",
    confidence: "93%",
    trend: "Stable",
    color: "#10b981",
    desc: "pH within normal range",
  },
  {
    label: "High Temperature Risk",
    level: "Low",
    confidence: "95%",
    trend: "Stable",
    color: "#10b981",
...
export const predictions = [
  { label: "Next 6h", val: "Stable", desc: "No significant changes expected" },
  {
    label: "Next 24h",
    val: "Slight DO drop",
    desc: "Overnight decrease possible",
  },
...
export const recommendations = [
  {
    text: "Inspect Buoy 03 within 48 hours",
    priority: "High",
    reason: "Turbidity increase",
  },
  {
  ...
  {
    text: "Increase sampling frequency at Buoy 02",
    priority: "High",
    reason: "DO decreasing",
  },
  {
    text: "Calibrate sensors on Buoy 04",
    priority: "Medium",
    reason: "Battery low",
  },
];
...
export const fishInsights = [
  { title: "Activity Level", value: "High", desc: "87% presence estimate" },
  {
    title: "School Size",
    value: "Medium",
    desc: "Estimated 200-400 individuals",
  },
  {
    title: "Recommended Zone",
    value: "Northwest",
    desc: "6.4m depth, optimal temp",
  },
  {
    title: "AI Confidence",
    value: "91%",
    desc: "Based on sonar + environmental data",
  },
];
