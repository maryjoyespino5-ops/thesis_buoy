                      ...
                      {!a.acknowledged && (
                        <>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-6 text-[9px] px-2 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50"
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-6 text-[9px] px-2 text-red-600 hover:text-red-700 hover:bg-red-50"
