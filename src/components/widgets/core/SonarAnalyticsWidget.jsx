// path: src/components/widgets/core/SonarAnalyticsWidget.jsx
import React from "react"
import { WidgetContainer } from "../system/WidgetContainer"
import { cn } from "../../../lib/utils"

export function SonarAnalyticsWidget({
  depth = "12.4m",
  bottomType = "Sandy",
  coverage = "Good",
  ...
  return (
    <WidgetContainer title="Sonar Analytics" icon="📡" className={className} {...props}>
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs text-text-muted">Fish Detected</span>
          <span className="text-sm font-semibold text-text-primary">{fishDetected}</span>
        </div>
