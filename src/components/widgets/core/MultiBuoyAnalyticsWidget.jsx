// path: src/components/widgets/core/MultiBuoyAnalyticsWidget.jsx
import React from "react"
import { WidgetContainer } from "../system/WidgetContainer"
import { cn } from "../../../lib/utils"

export function MultiBuoyAnalyticsWidget({
  buoys = [
  ...
  return (
    <WidgetContainer title="Multi-Buoy Analytics" icon="📊" className={className} {...props}>
