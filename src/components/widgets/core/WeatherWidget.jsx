// path: src/components/widgets/core/WeatherWidget.jsx
...
export function WeatherWidget({
  ...
  return (
    <WidgetContainer title="Weather" icon="🌤️" className={className} {...props}>
      <div className="flex items-center gap-3">
        <span className="text-4xl">{icon}</span>
        <div>
          <p className="text-2xl font-bold text-text-primary leading-none">{temperature}</p>
