// path: src/components/widgets/core/AIFisheriesAnalysisWidget.jsx
import React from "react"
import { WidgetContainer } from "../system/WidgetContainer"
import { cn } from "../../../lib/utils"

export function AIFisheriesAnalysisWidget({
  confidence = 89,
  summary = "Fish population is stable across all zones. Northwest zone shows highest activity. Recommend fishing in Zone North and Zone West.",
  className,
  ...props
}) {
  return (
    <WidgetContainer title="AI Fisheries Analysis" icon="🤖" className={className} {...props}>
