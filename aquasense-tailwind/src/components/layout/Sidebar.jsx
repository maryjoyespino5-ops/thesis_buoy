    ...
    <>
      ...
      <aside
        ...
        <div className="flex items-center gap-2.5 px-4 py-3.5 border-b border-border/50">
          ...
          <span className="text-[8px] font-mono bg-primary-50 text-primary-600 px-1.5 py-0.5 rounded ml-auto">
            v2.0
          </span>
        </div>
          ...
          {currentRole === "admin" &&
            adminFilteredGroups.map((group, gi) => (
              <div key={gi} className="mb-5">
                <p className="text-[9px] font-semibold uppercase tracking-wider text-text-muted px-1 mb-2">
                  {group.section}
                </p>
        ...
        <div className="border-t border-border/50 px-3 py-3 space-y-0.5">
          <NavLink
            to="/profile"
            onClick={() => setOpen(false)}
            className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-medium text-text-secondary hover:bg-surface-muted hover:text-text-primary transition-colors">
          ...
          <button
            ...
            className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-medium text-text-secondary hover:bg-red-50 hover:text-red-600 transition-colors w-full">
